...
// XXX duplicated code
public class ValidateSignature extends DefaultCommandWithKeystore {

    private final Logger logger = LoggerFactory.getLogger(ValidateSignature.class);
    ...
    public void runCommand() {
        ...
        verifySignatureWithPublicKey(message, publicKey);
    }
